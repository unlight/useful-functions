var self = module.exports; // module.exports = this

this.isArray = function isArray(a) {
	return (typeof(a) === "object") && (a instanceof Array);
}

this.isBool = function isBool(mixed) {
	// Returns true if variable is a boolean
	return (typeof mixed === 'boolean');
}

this.isNumeric = function isNumeric(mixed) {
	// Returns true if value is a number or a numeric string
	return (typeof(mixed) === 'number' || typeof(mixed) === 'string') && mixed !== '' && !isNaN(mixed);
}

this.isString = function isString(mixed) {
...
this.stringIsNullOrEmpty = function stringIsNullOrEmpty(s) {
	return (typeof s == 'undefined' || s === null || s === "");
}

this.trim = function trim(str, charlist) {
	// http://kevin.vanzonneveld.net
	// +   original by: Kevin van Zonneveld (http://kevin.vanzonneveld.net)
	var whitespace, l = 0,
		i = 0;
...
// Get file extension.
this.getExtension = function getExtension(path) {
	var s = path + '';
...
* credit: http://phpjs.org/functions/crc32:377
*/ 
this.crc32 = (function() {
	...
	return function(str) {
		for (var iTop = str.length, i = 0; i < iTop; i++) {
...
this.randomString = function randomString(Length, CharacterOptions) {
...
this.getClassName = function getClassName(actor) {
...
*/ 
this.hasValue = function hasValue(data, value) {
...
*/
this.setValue = function(key, collection, value) {
...
*/
this.getValue = function(key, collection, value, remove) {
...
*/
this.getValueI = function getValueI(Needle, Haystack, Default) {
...
* @return mixed The value from the array or object.
*/
this.getValueR = function getValueR(Key, Collection, Default) {
	if (typeof Default == 'undefined') Default = false;
	var Path = Key.split('.');
...
*/
this.touchValue = function touchValue(key, collection, value) {
